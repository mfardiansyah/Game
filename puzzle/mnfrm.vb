...
#Region "Private Fields"
        ...
        Friend WithEvents menuQuit As System.Windows.Forms.MenuItem
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.menuQuit = New System.Windows.Forms.MenuItem()
            ...
            Me.tilesPanel.Location = New System.Drawing.Point(14, 3)
            ...
            'mainMenu1
            '
            Me.mainMenu1.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.menuLoad, Me.menuShuffle, Me.menuSize, Me.menuQuit, Me.menuBack, Me.menuGridColor})
            '
            'menuLoad
            '
            Me.menuLoad.Index = 0
...
#Region "Make Tiles (int Rows, int Cols)"
        ...
        Public Sub MakeTiles(ByVal Rows As Integer, ByVal Cols As Integer)
            ...
            Me.ClientSize = New Size(tilesPanel.Size.Width + 8, tilesPanel.Size.Height + 30)
...
#End Region
        ...
        Private Sub menuBack_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles menuBack.Click
            FUtama.Show()
            Me.Hide()
        End Sub
